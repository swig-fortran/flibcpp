...
SWIGINTERN bool std_map_Sl_int_Sc_int_Sg__insert__SWIG(std::map< int,int > *self,int const &k,int const &v){
      std::pair<std::map<int, int, std::less< int > >::iterator, bool> result = self->insert(std::pair<int, int>(k, v));
      return result.second;
    }
SWIGINTERN int const &std_map_Sl_int_Sc_int_Sg__get__SWIG(std::map< int,int > *self,int const &k){
      return (*self)[k];
    }
SWIGINTERN void std_map_Sl_int_Sc_int_Sg__set__SWIG(std::map< int,int > *self,int const &k,int const &v){
      (*self)[k] = v;
    }
...
SWIGINTERN bool std_map_Sl_std_string_Sc_int_Sg__insert__SWIG(std::map< std::string,int > *self,std::string const &k,int const &v){
      std::pair<std::map<std::string, int, std::less< std::string > >::iterator, bool> result = self->insert(std::pair<std::string, int>(k, v));
      return result.second;
    }
SWIGINTERN int const &std_map_Sl_std_string_Sc_int_Sg__get__SWIG(std::map< std::string,int > *self,std::string const &k){
      return (*self)[k];
    }
SWIGINTERN void std_map_Sl_std_string_Sc_int_Sg__set__SWIG(std::map< std::string,int > *self,std::string const &k,int const &v){
      (*self)[k] = v;
    }
SWIGINTERN bool std_map_Sl_std_string_Sc_std_string_Sg__insert__SWIG(std::map< std::string,std::string > *self,std::string const &k,std::string const &v){
...
SWIGINTERN std::string const &std_map_Sl_std_string_Sc_std_string_Sg__get__SWIG(std::map< std::string,std::string > *self,std::string const &k){
      return (*self)[k];
    }

#include <string.h>

SWIGINTERN void std_map_Sl_std_string_Sc_std_string_Sg__set__SWIG(std::map< std::string,std::string > *self,std::string const &k,std::string const &v){
      (*self)[k] = v;
    }
extern "C" {
...
SWIGEXPORT size_t _wrap_MapIntInt_size(SwigClassWrapper *farg1) {
  size_t fresult ;
  std::map< int,int > *arg1 = (std::map< int,int > *) 0 ;
...
SWIGEXPORT size_t _wrap_MapIntInt_erase(SwigClassWrapper *farg1, int const *farg2) {
  size_t fresult ;
  std::map< int,int > *arg1 = (std::map< int,int > *) 0 ;
...
SWIGEXPORT size_t _wrap_MapIntInt_count(SwigClassWrapper *farg1, int const *farg2) {
  size_t fresult ;
  std::map< int,int > *arg1 = (std::map< int,int > *) 0 ;
  std::map< int,int >::key_type *arg2 = 0 ;
  std::map< int,int >::key_type temp2 ;
...
SWIGEXPORT int _wrap_MapIntInt_insert(SwigClassWrapper *farg1, int const *farg2, int const *farg3) {
  ...
  temp3 = (int)(*farg3);
  arg3 = &temp3;
  result = (bool)std_map_Sl_int_Sc_int_Sg__insert__SWIG(arg1,(int const &)*arg2,(int const &)*arg3);
  fresult = (result ? 1 : 0);
  return fresult;
}
...
SWIGEXPORT int _wrap_MapIntInt_get(SwigClassWrapper *farg1, int const *farg2) {
  ...
  temp2 = (int)(*farg2);
  arg2 = &temp2;
  result = (int *) &std_map_Sl_int_Sc_int_Sg__get__SWIG(arg1,(int const &)*arg2);
  fresult = *result;
  return fresult;
}
...
SWIGEXPORT void _wrap_MapIntInt_set(SwigClassWrapper *farg1, int const *farg2, int const *farg3) {
  ...
  temp3 = (int)(*farg3);
  arg3 = &temp3;
  std_map_Sl_int_Sc_int_Sg__set__SWIG(arg1,(int const &)*arg2,(int const &)*arg3);
}
...
SWIGEXPORT size_t _wrap_MapStringInt_size(SwigClassWrapper *farg1) {
  size_t fresult ;
  std::map< std::string,int > *arg1 = (std::map< std::string,int > *) 0 ;
...
SWIGEXPORT size_t _wrap_MapStringInt_erase(SwigClassWrapper *farg1, SwigArrayWrapper *farg2) {
  size_t fresult ;
  std::map< std::string,int > *arg1 = (std::map< std::string,int > *) 0 ;
...
SWIGEXPORT size_t _wrap_MapStringInt_count(SwigClassWrapper *farg1, SwigArrayWrapper *farg2) {
  size_t fresult ;
  std::map< std::string,int > *arg1 = (std::map< std::string,int > *) 0 ;
  std::map< std::string,int >::key_type *arg2 = 0 ;
  std::string tempstr2 ;
...
SWIGEXPORT int _wrap_MapStringInt_insert(SwigClassWrapper *farg1, SwigArrayWrapper *farg2, int const *farg3) {
  ...
  temp3 = (int)(*farg3);
  arg3 = &temp3;
  result = (bool)std_map_Sl_std_string_Sc_int_Sg__insert__SWIG(arg1,(std::string const &)*arg2,(int const &)*arg3);
  fresult = (result ? 1 : 0);
  return fresult;
}
...
SWIGEXPORT int _wrap_MapStringInt_get(SwigClassWrapper *farg1, SwigArrayWrapper *farg2) {
  ...
  tempstr2 = std::string(static_cast<char *>(farg2->data), farg2->size);
  arg2 = &tempstr2;
  result = (int *) &std_map_Sl_std_string_Sc_int_Sg__get__SWIG(arg1,(std::string const &)*arg2);
  fresult = *result;
  return fresult;
}
...
SWIGEXPORT void _wrap_MapStringInt_set(SwigClassWrapper *farg1, SwigArrayWrapper *farg2, int const *farg3) {
  ...
  temp3 = (int)(*farg3);
  arg3 = &temp3;
  std_map_Sl_std_string_Sc_int_Sg__set__SWIG(arg1,(std::string const &)*arg2,(int const &)*arg3);
}
...
SWIGEXPORT size_t _wrap_MapStringString_size(SwigClassWrapper *farg1) {
  size_t fresult ;
  std::map< std::string,std::string > *arg1 = (std::map< std::string,std::string > *) 0 ;
...
SWIGEXPORT size_t _wrap_MapStringString_erase(SwigClassWrapper *farg1, SwigArrayWrapper *farg2) {
  size_t fresult ;
  std::map< std::string,std::string > *arg1 = (std::map< std::string,std::string > *) 0 ;
...
SWIGEXPORT size_t _wrap_MapStringString_count(SwigClassWrapper *farg1, SwigArrayWrapper *farg2) {
  size_t fresult ;
  std::map< std::string,std::string > *arg1 = (std::map< std::string,std::string > *) 0 ;
  std::map< std::string,std::string >::key_type *arg2 = 0 ;
  std::string tempstr2 ;
...
SWIGEXPORT int _wrap_MapStringString_insert(SwigClassWrapper *farg1, SwigArrayWrapper *farg2, SwigArrayWrapper *farg3) {
  ...
  arg3 = &tempstr3;
  result = (bool)std_map_Sl_std_string_Sc_std_string_Sg__insert__SWIG(arg1,(std::string const &)*arg2,(std::string const &)*arg3);
  fresult = (result ? 1 : 0);
  return fresult;
}
