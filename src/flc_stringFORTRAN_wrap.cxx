...
SWIGINTERN void std_string_set__SWIG(std::string *self,std::string::size_type index,std::string::value_type v){
        SWIG_check_range(index, self->size(),
                         "std::string::set",
                         return);
        (*self)[index] = v;
      }
SWIGINTERN std::string::value_type std_string_get__SWIG(std::string *self,std::string::size_type index){
        SWIG_check_range(index, self->size(),
                         "std::string::get",
                         return self->front());
        return (*self)[index];
      }
SWIGINTERN std::string &std_string_view__SWIG(std::string *self){ return *self; }
SWIGINTERN std::string const &std_string_str__SWIG(std::string *self){ return *self; }
...
SWIGEXPORT void _wrap_string_set(SwigClassWrapper *farg1, size_t const *farg2, char const *farg3) {
  ...
  arg2 = *farg2 - 1;
  arg3 = (std::string::value_type)(*farg3);
  std_string_set__SWIG(arg1,arg2,arg3);
}
...
SWIGEXPORT SwigArrayWrapper _wrap_string_view(SwigClassWrapper *farg1) {
  ...
  arg1 = (std::string *)farg1->cptr;
  result = (std::string *) &std_string_view__SWIG(arg1);
...
SWIGEXPORT SwigArrayWrapper _wrap_string_str(SwigClassWrapper *farg1) {
  ...
  arg1 = (std::string *)farg1->cptr;
  result = (std::string *) &std_string_str__SWIG(arg1);
  fresult.size = result->size();
  if (fresult.size > 0) {
